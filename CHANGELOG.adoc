...
- https://github.com/ObeoNetwork/pepper/issues/68[#68] Prevent cyclic dependencies creation
Prevent dependency creation between a task and one of its child and a task depending on one of the target task's parent
...
- https://github.com/ObeoNetwork/pepper/issues/76[#76] Round task time should support rounded dates


=== Bug fixes

- https://github.com/ObeoNetwork/pepper/issues/74[#74] Improve dates in Pepper Sample template
