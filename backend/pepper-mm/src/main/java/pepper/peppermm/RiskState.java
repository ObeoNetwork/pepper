...
public enum RiskState implements Enumerator {
    ...
    /**
	 * An array of all the '<em><b>Risk State</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    private static final RiskState[] VALUES_ARRAY = new RiskState[] {
			ON_GOING,
			UNDER_INSTRUCTION,
			STOP_BEFORE_TERM,
			COMPLETED,
    ...
    /**
	 * A public read-only list of all the '<em><b>Risk State</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>Risk State</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns the '<em><b>Risk State</b></em>' literal with the specified name.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
    ...
    /**
	 * Returns the '<em><b>Risk State</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
