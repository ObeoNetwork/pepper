...
public enum ProjectState implements Enumerator {
    ...
    /**
     * An array of all the '<em><b>Project State</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    private static final ProjectState[] VALUES_ARRAY = new ProjectState[] { ON_GOING, UNDER_INSTRUCTION, STOP_BEFORE_TERM, COMPLETED, };

    /**
     * A public read-only list of all the '<em><b>Project State</b></em>' enumerators. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * Returns the '<em><b>Project State</b></em>' literal with the specified literal value. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @param literal
     *            the literal.
    ...
    /**
     * Returns the '<em><b>Project State</b></em>' literal with the specified name. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @param name
     *            the name.
    ...
    /**
     * Returns the '<em><b>Project State</b></em>' literal with the specified integer value. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @param value
     *            the integer value.
