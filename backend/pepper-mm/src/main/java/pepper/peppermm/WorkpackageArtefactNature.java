...
public enum WorkpackageArtefactNature implements Enumerator {
    /**
	 * The '<em><b>Delivrable</b></em>' literal object.
    ...
    /**
	 * The '<em><b>Decisional</b></em>' literal object.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * The '<em><b>Project Review</b></em>' literal object.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * The '<em><b>Invoicing</b></em>' literal object.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #INVOICING_VALUE
	 * @generated
	 * @ordered
    ...
    /**
	 * The '<em><b>Expense Statement</b></em>' literal object.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * The '<em><b>Client Satisfaction</b></em>' literal object.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * The '<em><b>Delivrable</b></em>' literal value.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #DELIVRABLE
    ...
    /**
	 * The '<em><b>Decisional</b></em>' literal value.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #DECISIONAL
    ...
    /**
	 * The '<em><b>Project Review</b></em>' literal value.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #PROJECT_REVIEW
    ...
    /**
	 * The '<em><b>Invoicing</b></em>' literal value.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #INVOICING
    ...
    /**
	 * The '<em><b>Expense Statement</b></em>' literal value.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * The '<em><b>Client Satisfaction</b></em>' literal value.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * An array of all the '<em><b>Workpackage Artefact Nature</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    private static final WorkpackageArtefactNature[] VALUES_ARRAY = new WorkpackageArtefactNature[] {
			DELIVRABLE,
			DECISIONAL,
			PROJECT_REVIEW,
			ACTION,
    ...
    /**
	 * A public read-only list of all the '<em><b>Workpackage Artefact Nature</b></em>' enumerators.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>Workpackage Artefact Nature</b></em>' literal with the specified name.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
    ...
    public static WorkpackageArtefactNature get(int value) {
		switch (value) {
			case DELIVRABLE_VALUE: return DELIVRABLE;
			case DECISIONAL_VALUE: return DECISIONAL;
			case PROJECT_REVIEW_VALUE: return PROJECT_REVIEW;
			case ACTION_VALUE: return ACTION;
			case INVOICING_VALUE: return INVOICING;
			case EXPENSE_STATEMENT_VALUE: return EXPENSE_STATEMENT;
			case CLIENT_SATISFACTION_VALUE: return CLIENT_SATISFACTION;
