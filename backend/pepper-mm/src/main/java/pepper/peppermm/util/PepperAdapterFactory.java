...
public class PepperAdapterFactory extends AdapterFactoryImpl {
    ...
    /**
	 * Creates a new adapter for an object of class '{@link pepper.peppermm.Team <em>Team</em>}'.
	 * <!-- begin-user-doc
    ...
    /**
	 * Creates a new adapter for an object of class '{@link pepper.peppermm.InternalStakeholder <em>Internal Stakeholder</em>}'.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link pepper.peppermm.ExternalStakeholder <em>External Stakeholder</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link pepper.peppermm.Task <em>Task</em>}'.
	 * <!-- begin-user-doc
     * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case
     * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link pepper.peppermm.WorkpackageArtefact <em>Workpackage Artefact</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link pepper.peppermm.Risk <em>Risk</em>}'.
	 * <!-- begin-user-doc
     * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case
     * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
