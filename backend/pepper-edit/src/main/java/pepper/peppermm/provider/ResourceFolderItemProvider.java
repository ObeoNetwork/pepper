...
/**
 * This is the item provider adapter for a {@link pepper.peppermm.ResourceFolder} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class ResourceFolderItemProvider extends ItemProviderAdapter
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceFolder_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceFolder_name_feature", "_UI_ResourceFolder_type"),
				 PepperPackage.Literals.RESOURCE_FOLDER__NAME,
				 true,
				 false,
				 false,
    ...
    /**
	 * This returns ResourceFolder.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ResourceFolder"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ResourceFolder_type") :
			getString("_UI_ResourceFolder_type") + " " + label;
	}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PepperPackage.Literals.RESOURCE_FOLDER__OWNED_RESOURCES,
				 PepperFactory.eINSTANCE.createTeam()));

		newChildDescriptors.add
			(createChildParameter
				(PepperPackage.Literals.RESOURCE_FOLDER__OWNED_RESOURCES,
				 PepperFactory.eINSTANCE.createInternalStakeholder()));
		...
		newChildDescriptors.add
			(createChildParameter
				(PepperPackage.Literals.RESOURCE_FOLDER__OWNED_RESOURCES,
				 PepperFactory.eINSTANCE.createPerson()));

		newChildDescriptors.add
			(createChildParameter
				(PepperPackage.Literals.RESOURCE_FOLDER__SUB_FOLDERS,
