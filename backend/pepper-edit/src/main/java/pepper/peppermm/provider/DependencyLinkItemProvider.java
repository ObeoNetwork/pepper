...
/**
 * This is the item provider adapter for a {@link pepper.peppermm.DependencyLink} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PepperPackage.Literals.DEPENDENCY_LINK__TARGET_KIND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PepperPackage.Literals.DEPENDENCY_LINK__SOURCE_KIND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PepperPackage.Literals.DEPENDENCY_LINK__SOURCE,
				 true,
				 false,
				 false,
				 null,
