...
/**
 * This is the item provider adapter for a {@link pepper.peppermm.AbstractTask} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PepperPackage.Literals.ABSTRACT_TASK__START_TIME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PepperPackage.Literals.ABSTRACT_TASK__END_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addCalculationOptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractTask_calculationOption_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractTask_calculationOption_feature", "_UI_AbstractTask_type"),
				 PepperPackage.Literals.ABSTRACT_TASK__CALCULATION_OPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractTask_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractTask_duration_feature", "_UI_AbstractTask_type"),
				 PepperPackage.Literals.ABSTRACT_TASK__DURATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
