...
/**
 * This is the item provider adapter for a {@link pepper.peppermm.WorkpackageArtefact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkpackageArtefactItemProvider extends ItemProviderAdapter
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkpackageArtefact_nature_feature", "_UI_WorkpackageArtefact_type"),
				 PepperPackage.Literals.WORKPACKAGE_ARTEFACT__NATURE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    /**
	 * This adds a property descriptor for the Planned Deadline feature.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    protected void addPlannedDeadlinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkpackageArtefact_plannedDeadline_feature"),
				 ...
				 PepperPackage.Literals.WORKPACKAGE_ARTEFACT__PLANNED_DEADLINE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addEffectiveDeadLinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkpackageArtefact_effectiveDeadLine_feature"),
				 ...
				 PepperPackage.Literals.WORKPACKAGE_ARTEFACT__EFFECTIVE_DEAD_LINE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    /**
	 * This adds a property descriptor for the Is Invoice Trigger feature.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * This adds a property descriptor for the Invoice Amount feature.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    ...
    protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkpackageArtefact_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkpackageArtefact_version_feature", "_UI_WorkpackageArtefact_type"),
				 PepperPackage.Literals.WORKPACKAGE_ARTEFACT__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkpackageArtefact_isObsolete_feature", "_UI_WorkpackageArtefact_type"),
				 PepperPackage.Literals.WORKPACKAGE_ARTEFACT__IS_OBSOLETE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    /**
	 * This returns WorkpackageArtefact.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WorkpackageArtefact"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_WorkpackageArtefact_type") :
			getString("_UI_WorkpackageArtefact_type") + " " + label;
	}
