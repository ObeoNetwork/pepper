...
import pepper.peppermm.provider.RiskItemProvider;

/** Customization of the item provider implementation generated by EMF. */
public class RiskItemProviderSpec extends RiskItemProvider {
    public RiskItemProviderSpec(AdapterFactory adapterFactory) {
