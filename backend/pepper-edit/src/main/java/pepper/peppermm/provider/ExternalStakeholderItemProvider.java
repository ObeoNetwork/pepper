...
/**
 * This is the item provider adapter for a {@link pepper.peppermm.ExternalStakeholder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExternalStakeholderItemProvider extends ResourceItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExternalStakeholder_goals_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExternalStakeholder_goals_feature", "_UI_ExternalStakeholder_type"),
				 PepperPackage.Literals.EXTERNAL_STAKEHOLDER__GOALS,
				 true,
				 false,
				 false,
    ...
    /**
	 * This returns ExternalStakeholder.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExternalStakeholder"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ExternalStakeholder_type") :
			getString("_UI_ExternalStakeholder_type") + " " + label;
	}
