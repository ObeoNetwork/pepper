...
public class ExternalStakeholderItemProvider extends ResourceItemProvider {
    ...
    protected void addGoalsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ExternalStakeholder_goals_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ExternalStakeholder_goals_feature", "_UI_ExternalStakeholder_type"),
                PepperPackage.Literals.EXTERNAL_STAKEHOLDER__GOALS, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, this.getClass().getClassLoader().getResource("icons/full/obj16/ExternalStakeholder.svg"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ExternalStakeholder_type") : getString("_UI_ExternalStakeholder_type") + " " + label;
    }
