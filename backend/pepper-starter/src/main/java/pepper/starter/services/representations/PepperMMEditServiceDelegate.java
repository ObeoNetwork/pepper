 ...
 */
@Service
public class PepperMMEditServiceDelegate extends DefaultEditService implements IExplorerLabelServiceDelegate {

    public PepperMMEditServiceDelegate(IEMFKindService emfKindService, Optional<ISuggestedRootObjectTypesProvider> optionalSuggestedRootObjectsProvider,
