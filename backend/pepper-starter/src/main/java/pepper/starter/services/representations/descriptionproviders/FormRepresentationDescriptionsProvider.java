 ...
 */
@Service
public class FormRepresentationDescriptionsProvider implements IRepresentationDescriptionsProvider {

    private final IViewRepresentationDescriptionSearchService viewRepresentationDescriptionSearchService;

    private final List<IJavaServiceProvider> javaServiceProviders;

    public FormRepresentationDescriptionsProvider(IViewRepresentationDescriptionSearchService viewRepresentationDescriptionSearchService, List<IJavaServiceProvider> javaServiceProviders) {
    ...
    public boolean canHandle(IRepresentationDescription representationDescription) {
        return FormEditingContextDescriptionProvider.PROJECT_FORM_ID.equals(representationDescription.getId());
    }
